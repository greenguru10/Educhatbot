      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
        <div className="flex items-center justify-between p-5 border-b border-slate-800 bg-slate-950/50">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-semibold text-white">Learner Profiles</h3>
              <p className="text-xs text-slate-400">Each profile maintains isolated chat histories & saved notes</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-5 space-y-4 max-h-[60vh] overflow-y-auto">
          ...
          {isCreating ? (
            <form onSubmit={handleCreate} className="p-4 rounded-xl bg-slate-950/60 border border-slate-800 space-y-3">
              ...
              <div>
                <label className="text-xs text-slate-400 block mb-1">Learner Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-xs text-slate-400 block mb-1">Field / Role</label>
                <select
                  value={newUserRole}
              ...
              <div className="flex gap-2 pt-1">
                ...
                <button
                  ...
                  className="py-2 px-3 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs transition-colors"
                >
                  Cancel
                </button>
              </div>
            ...
            <button
              ...
              className="w-full py-2.5 px-3 rounded-xl border border-dashed border-slate-700 hover:border-emerald-500/50 hover:bg-emerald-500/5 text-slate-400 hover:text-emerald-400 flex items-center justify-center gap-2 text-xs font-medium transition-all"
            >
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-950/30 flex items-center justify-between text-[11px] text-slate-500">
