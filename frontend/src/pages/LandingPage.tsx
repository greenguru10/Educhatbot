...
export const LandingPage: React.FC<LandingPageProps> = ({ onStartChat }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-emerald-500 selection:text-black overflow-x-hidden">
      {/* Background Ambient Glow */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-10%] left-[20%] w-[500px] h-[500px] bg-emerald-500/10 rounded-full blur-[120px]" />
        <div className="absolute top-[30%] right-[10%] w-[600px] h-[600px] bg-cyan-500/10 rounded-full blur-[140px]" />
        <div className="absolute bottom-[-10%] left-[30%] w-[500px] h-[500px] bg-teal-500/10 rounded-full blur-[120px]" />
      </div>
      ...
      <section className="relative pt-20 pb-16 md:pt-28 md:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            href="#demo"
            className="w-full sm:w-auto px-6 py-4 rounded-2xl bg-slate-900/80 hover:bg-slate-800 border border-slate-800 text-slate-200 font-semibold text-base transition-all flex items-center justify-center gap-2"
          >
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-2 max-w-3xl mx-auto">
          ...
          {demoQueries.map((q, idx) => (
            <button
              ...
              className="text-xs px-3 py-1.5 rounded-lg bg-slate-900/90 border border-slate-800 hover:border-emerald-500/40 hover:text-emerald-300 text-slate-400 transition-all text-left"
            >
        ...
        <div id="demo" className="mt-14 relative max-w-4xl mx-auto rounded-2xl border border-slate-800 bg-slate-900/90 shadow-2xl shadow-emerald-500/5 overflow-hidden text-left">
          <div className="h-10 px-4 bg-slate-950 border-b border-slate-800 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="ml-2 text-xs font-mono text-slate-400">learnwise-session · BST-Insertion</span>
            </div>
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 bg-slate-950/70 border border-slate-800/80 p-4 rounded-2xl rounded-tl-sm text-sm text-slate-300 space-y-3">
                <p>
                  ...
                  <span className="inline-flex items-center px-1.5 py-0.2 text-[11px] font-semibold rounded bg-emerald-500/20 text-emerald-400 border border-emerald-500/30 cursor-pointer">
                ...
                <div className="flex items-center justify-between text-xs text-slate-400 pt-1">
                  <span>Average Time Complexity: <strong className="text-emerald-400">O(log n)</strong></span>
                  <button
      ...
      <section id="features" className="py-20 bg-slate-900/40 border-y border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-slate-900/70 border border-slate-800 hover:border-emerald-500/30 transition-all group">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Verified Citation Grounding</h3>
            ...
            <div className="p-6 rounded-2xl bg-slate-900/70 border border-slate-800 hover:border-cyan-500/30 transition-all group">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Groq 120B Speed</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-900/70 border border-slate-800 hover:border-teal-500/30 transition-all group">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Syntax Highlighted Code</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-900/70 border border-slate-800 hover:border-emerald-500/30 transition-all group">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Isolated User Profiles</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-900/70 border border-slate-800 hover:border-cyan-500/30 transition-all group">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Personal Study Notebook</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-slate-900/70 border border-slate-800 hover:border-teal-500/30 transition-all group">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Audio Read-Aloud (TTS)</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
      ...
      <section id="curriculum" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            <div className="text-emerald-400 text-xs font-semibold uppercase tracking-wider mb-2">Pre-Indexed Library</div>
            <h2 className="text-3xl font-bold text-white">Active Academic Domains</h2>
          </div>
          <button
            onClick={() => onStartChat()}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {topics.map((t, idx) => (
            <div
              ...
              className="p-5 rounded-xl bg-slate-900/60 border border-slate-800 hover:border-emerald-500/40 hover:bg-slate-900 transition-all cursor-pointer flex items-center justify-between group"
            >
              <div>
                <span className="text-[10px] font-semibold uppercase px-2 py-0.5 rounded bg-slate-800 text-slate-400 group-hover:bg-emerald-500/10 group-hover:text-emerald-400 transition-colors">
                  {t.tag}
                </span>
                <h4 className="text-sm font-semibold text-slate-200 mt-2 group-hover:text-white transition-colors">
                  {t.title}
                </h4>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <div className="relative rounded-3xl bg-gradient-to-tr from-emerald-950/60 via-slate-900 to-cyan-950/60 border border-emerald-500/30 p-8 sm:p-12 text-center overflow-hidden shadow-2xl">
          ...
          <div className="mt-8 flex justify-center">
            <button
              onClick={() => onStartChat()}
              className="px-8 py-4 rounded-2xl bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 hover:opacity-95 text-slate-950 font-bold text-base shadow-xl shadow-emerald-500/20 hover:scale-105 transition-all flex items-center gap-2"
            >
